function [sys,x0,str,ts,simStateCompliance] = shipNL_Sfun(t,x,u,flag,p)
...
switch flag,
  ...
  %%%%%%%%%%%%%%%%%%
  case 0,
    [sys,x0,str,ts,simStateCompliance]=mdlInitializeSizes(p.x0);
